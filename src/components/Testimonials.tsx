...
const testimonials = [
  {
    ...
    rating: 5,
    text: "Porte claquée à 23h, le serrurier était là en 22 minutes chrono. Professionnel, efficace, et le prix annoncé par téléphone était celui sur la facture. Je recommande sans hésiter.",
  ...
  },
  {
    ...
    rating: 5,
    text: "Blindage de porte après déménagement. Le serrurier explique chaque étape, le résultat est top. La porte est vraiment solide maintenant. 5 étoiles méritées.",
